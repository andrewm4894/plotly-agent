...
class PlotDescriptionInput(BaseModel):
    plot_description: str = Field(..., description="Description of the plot the user wants to create")
...
class PlotlyAgentExecutionEnvironment:
    ...
    def __init__(self, df: pd.DataFrame):
        self.df = df
        self.locals_dict = {"df": df, "px": px, "go": go, "pd": pd}
        self.output = None
        self.error = None
        self.fig = None
...
class PlotlyAgent:
    def __init__(self, model="gpt-4o"):
        ...
        self.last_generated_code = None  # Store the last generated code
    ...
    def _initialize_agent(self):
        ...
        sql_context = ""
        if self.sql_query:
            sql_context = f"The DataFrame was generated using the following SQL query:\n{self.sql_query}"
